...
const sendConnectionRequest = async (req, res) => {
    try {
        const { 
            targetUserId,    // ID of user being contacted
            message,         // Custom message from requesting user
            skillInterested  // Skill they're interested in learning
        } = req.body;
        ...
        // Get requesting user's details (assuming you're using authentication)
        // Note: You'll need to modify this based on how you're handling authentication
        const requestingUser = await User.findById(req.user._id);

        // Create HTML email template for target user
        ...
        // Create HTML email template for requesting user (confirmation)
        ...
        try {
            ...
            // Log email errors but don't affect the response since it's already sent
